...
/**
 * goAML {@code t_person_my_client} — same shape as {@link TPerson} but stricter (more fields
 * mandatory at validation time). Modeled as a separate class so JAXB emits the correct schema
 * type name for "my client" persons.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "t_person_my_client", propOrder = {
