...
/**
 * goAML {@code t_account_my_client} — stricter "my client" variant of {@link TAccount}.
 * Same Phase 3 surface; mandatory-field enforcement comes from the validation engine
 * (Phase 5), not the POJO.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "t_account_my_client", propOrder = {
